...
public class GeographicalDistance {
	...
	public static Double geographicalDistanceV1(Coordinates source, Coordinates target) {
	...
	public static Double geographicalDistanceV2(Coordinates source, Coordinates target) {
		...
		Double angularDistance = 2 * Math.asin(Math.sqrt(halfChordLength));
		return EARTH_RADIUS * angularDistance;
	}
	...
	public static void main(String[] args) {
		...
		Double distanceV1 = geographicalDistanceV1(seville, huelva);
		Double distanceV2 = geographicalDistanceV2(seville, huelva);

		System.out.println("Distance V1: " + distanceV1);
		System.out.println("Distance V2: " + distanceV2);
		System.out.println("Diferencia: " + Math.abs(distanceV1 - distanceV2));
