...
public class EventData {
	public static List<Event>getEventsInfo(){
		...
		event2.setDate(LocalDateTime.of(2022,5,21, 21,00));
		...
		event3.setDate(LocalDateTime.of(2022,6,11, 22,00));
		...
		event7.setDate(LocalDateTime.of(2022,5,29, 10,00));
		...
		event8.setDate(LocalDateTime.of(2022,7,3, 11,00));
		...
		event9.setDate(LocalDateTime.of(2022,7,22, 11,00));
		...
		event10.setDate(LocalDateTime.of(2022,9,11, 11,00));
		...
		event11.setDate(LocalDateTime.of(2022,6,2, 21,00));
		...
		event13.setDate(LocalDateTime.of(2022,8,18, 18,00));
		...
		event14.setDate(LocalDateTime.of(2022,10,3, 19,00));
		...
		event15.setDate(LocalDateTime.of(2022,5,28, 11,00));
		...
		event16.setDate(LocalDateTime.of(2022,6,18, 12,00));
		...
		event17.setDate(LocalDateTime.of(2022,5,29, 17,00));
		...
		event18.setDate(LocalDateTime.of(2022,11,18, 21,00));
